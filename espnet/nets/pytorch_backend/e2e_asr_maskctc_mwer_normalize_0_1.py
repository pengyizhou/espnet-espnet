...
from espnet.nets.pytorch_backend.calcute_mwer_normalize import Calcute_Minmum_Word_Error_Rate
class E2E(E2ETransformer):
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        for i in range(xs_pad.shape[0]):
            ...
            best_scores, best_ids = self.recognize_mwer(xs_pad[i])
        ...
        logging.warning("## CTC loss: {}, Att loss: {}, mwer loss: {}, org loss: {}, final loss: {}".format(float(loss_ctc), float(loss_att), float(mwer_loss), float(alpha * loss_ctc + (1 - alpha)), loss_data))
