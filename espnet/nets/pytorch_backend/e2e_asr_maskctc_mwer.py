...
class E2E(E2ETransformer):
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        self.maskctc_probability_threshold = 0.99
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        logging.warning("## CTC loss: {}, Att loss: {}, org loss: {}, final loss: {}".format(float(loss_ctc), float(loss_att), float(alpha * loss_ctc + (1 - alpha)), loss_data))
