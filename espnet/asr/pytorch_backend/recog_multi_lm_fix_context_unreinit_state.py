...
from espnet.nets.beam_search_multi_lm_fix_context_unreinit_state import BeamSearch
...
def recog_v2(args):
    ...
    if args.mono_score:
        if args.mono_score == "ENG":
            fusion_part = "SGE"
        elif args.mono_score == "MAN":
            fusion_part = "MAN"
        elif args.mono_score == "ALL" or args.mono_score == "SW":
            fusion_part = args.mono_score
    ...
    beam_search = BeamSearch(
        ...
        switching_label_id=6960,
        switching_id=2966, # > 2966 is Chinese, <= 2966 is English
        fusion_penalty=fusion_part,
