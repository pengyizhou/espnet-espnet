...
from espnet.nets.beam_search_sw import BeamSearch
...
def recog_v2(args):
    ...
    beam_search = BeamSearch(
        ...
        penalty_ratio=float(args.penalty_ratio) if args.penalty_ratio is not None else None,
        award_score=float(args.award_score) if args.award_score is not None else None,
